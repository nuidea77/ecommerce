...
class UserSeeder extends Seeder
{
    public function run(): void
    {
        $users = [
            ...
            ['name' => 'Сарнай', 'email' => 'customer@beautypro.mn', 'phone' => '99887766', 'role' => 'customer', 'city' => 'Улаанбаатар', 'address' => 'Хан-Уул дүүрэг, 15-р хороо, Мишээл экспо, Beauty Studio'],
            ['name' => 'Номин', 'email' => 'nomin@salon.mn', 'phone' => '95123456', 'role' => 'customer', 'city' => 'Улаанбаатар', 'address' => 'Баянзүрх дүүрэг, 26-р хороо, Nomin Beauty Salon'],
