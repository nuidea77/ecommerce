...
class UserSeeder extends Seeder
{
    public function run(): void
    {
        $users = [
            ...
            ['name' => 'Сарнай', 'email' => 'customer@chanaresui.mn', 'phone' => '99887766', 'role' => 'customer', 'city' => 'Улаанбаатар', 'address' => 'Хан-Уул дүүрэг, 15-р хороо, Мишээл экспо, Beauty Studio', 'is_verified' => true, 'verified_at' => now()->subDays(30), 'verify_provider' => 'verify.mn-mock', 'verified_phone' => '99887766'],
