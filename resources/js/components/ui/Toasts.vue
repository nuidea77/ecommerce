...
<template>
    <div aria-live="polite" class="pointer-events-none fixed inset-0 z-[100] flex flex-col items-end gap-2 px-4 py-6 sm:p-6">
        <transition-group name="fade">
            <div v-for="t in ui.toasts" :key="t.id" class="pointer-events-auto flex w-full max-w-sm items-start gap-3 rounded-xl bg-white p-4 shadow-lg ring-1 ring-stone-200">
