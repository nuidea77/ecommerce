...
<template>
    <article class="group flex h-full flex-col overflow-hidden rounded-2xl bg-white ring-1 ring-stone-200/70 transition hover:shadow-lg hover:shadow-stone-900/5">
        <router-link :to="{ name: 'product', params: { slug: product.slug } }" class="relative block aspect-square overflow-hidden bg-white p-3">
            <img :src="product.thumbnail" :alt="product.name" class="h-full w-full object-contain transition duration-700 group-hover:scale-105" />
